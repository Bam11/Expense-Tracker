...
import {
  Sun, Moon, LayoutDashboard, ReceiptText, BarChart, Landmark, Settings, Bell, TrendingUp, TrendingDown, RefreshCcw, Link2, Sparkle, Wallet, Calendar, ShoppingBasket, ShoppingCart, CarFront, Coffee, Store,
  Plus
} from "lucide-react";
      ...
      <div className="bg-[#f8f6f6] dark:bg-[#0A0A0A] text-slate-900 dark:text-slate-100 antialiased font-['Public_Sans',sans-serif]">
        <div className="flex h-screen overflow-hidden">
          ...
          <main className="flex-1 flex flex-col overflow-hidden bg-slate-50 dark:bg-[#0A0A0A] relative w-full pb-20 md:pb-0">
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-24 md:p-8">
            ...
            <div className="md:hidden absolute bottom-0 left-0 right-0 bg-white/80 dark:bg-[#0A0A0A]/80 backdrop-blur-xl border-t border-slate-200 dark:border-[#1F1F1F] px-4 pb-8 pt-4 z-50">
              <div className="flex items-center justify-between relative">
                ...
                <div className="absolute left-1/2 -translate-x-1/2 -top-10">
                  <button className="h-14 w-14 rounded-full bg-gradient-to-br from-[#6B46FF] to-[#3b82f6] shadow-lg shadow-[#6B46FF]/30 flex items-center justify-center text-white hover:scale-105 active:scale-95 transition-transform">
          ...
          <aside className="hidden xl:flex w-80 border-l border-slate-200 dark:border-[#1F1F1F] flex-col bg-white dark:bg-[#0A0A0A] p-6 overflow-y-auto shrink-0 z-10">
